...
# address = "https://zingmp3.vn/tim-kiem"
browser.get(address)
sleep(2)


# read the data from database 
df = pd.read_csv("Output\Missing_Song_Data_1.0.csv")
...
while number_song <= 2000:
    try:
        ...
        for i in range(1,4):
            ...
            try:
                list_song = browser.find_element_by_xpath(f'//*[@id="body-scroll"]/div[1]/div/div[2]/div/div[1]/div/div[{i}]/div/div[1]/div[2]/div/span')
            except:
